...
export default function Hero({ onCTA }) {
  return (
    <section className="relative min-h-screen pt-[60px] bg-white flex items-center overflow-hidden">
      {/* Subtle radial glow */}
      <div className="absolute top-[-100px] right-[-200px] w-[700px] h-[700px] bg-[radial-gradient(circle,rgba(72,217,81,0.06)_0%,transparent_65%)] pointer-events-none" />
        ...
        <div>
          ...
          <Reveal delay={80}>
            <h1 className="text-[clamp(38px,5vw,62px)] font-extrabold leading-[1.04] tracking-[-2px] text-black mb-[22px]">
              ...
              <span className="bg-[linear-gradient(90deg,#1DAB25,#48D951,#1DAB25)] bg-[length:200%_auto] bg-clip-text text-transparent animate-[shimmer_3s_linear_infinite]">
                avant de parler.
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={240}>
            <div className="flex items-center gap-3 flex-wrap">
              <BtnHero href="#" onClick={(e) => { e.preventDefault(); onCTA?.(); }}>
